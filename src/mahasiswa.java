...
public class mahasiswa extends client{
    ...
    public mahasiswa(String nama, String alamat, String telp, String prodi, String fakultas, String username,
            String password, String nim) {
    ...
    public void displayMahasiswaDetails(ArrayList<mahasiswa> databaseMahasiswa) {
        ...
        Object[][] rowData = dataGenerator(databaseMahasiswa.size(), columnNames);
        for(int i = 0; i < rowData.length; i++){
            mahasiswa data = databaseMahasiswa.get(i);
            ...
            rowData[i][5] = data.getNim();
            rowData[i][6] = data.getUsername();
            rowData[i][7] = data.getPassword();

            
        }
        generateTable("Mahasiswa Detail", tableFormatter(rowData, columnNames).split("/")[0], rowData, columnNames, Integer.parseInt(tableFormatter(rowData, columnNames).split("/")[1]));
        try {
            printTXT("Mahasiswa Detail", tableFormatter(rowData, columnNames).split("/")[0], rowData, "Mahasiswa.txt", columnNames, Integer.parseInt(tableFormatter(rowData, columnNames).split("/")[1]));
        } catch (IOException e) {
